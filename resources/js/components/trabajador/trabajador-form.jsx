...
import { UserCog, User, MapPin, Briefcase, Plus } from "lucide-react"
...
export function WorkerForm() {
  const [formData, setFormData] = useState({
    ...
    telefono: "",
    tipo: "",
    especialidad: "", // Agregando especialidad al estado
    profesion: "",
    id_colonia: "",
    direccion: "",
    codigo_postal: "",
      ...
      <div className="bg-background border-b shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Alta de Trabajador</h1>
              <p className="text-sm text-muted-foreground">Gestión de Trabajadores / Nuevo Trabajador</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-background rounded-lg shadow-sm border p-8">
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <TextField
                    ...
                    onChange={(e) => updateField("ap_paterno", e.target.value)}
                    required
                    fullWidth
                    variant="outlined"
                    size="small"
                ...
                <div className="space-y-2">
                  ...
                  <TextField
                    ...
                    onChange={(e) => updateField("ap_materno", e.target.value)}
                    fullWidth
                    variant="outlined"
                    size="small"
                    sx={{
            ...
            <div className="space-y-6 pb-6 border-b">
              ...
              <div className={`grid gap-6 ${formData.tipo === "instructor" ? "md:grid-cols-3" : "md:grid-cols-2"}`}>
                <div className="space-y-2">
                  <Label htmlFor="tipo">Tipo de Trabajador *</Label>
                  <TextField
                    id="tipo"
                    select
                    value={formData.tipo}
            ...
            <div className="space-y-6 pb-6 border-b">
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    ...
                    <TextField
                      ...
                      onChange={(e) => updateField("no_exterior", e.target.value)}
                      required
                      fullWidth
                      variant="outlined"
                      size="small"
                  ...
                  <div className="space-y-2">
                    ...
                    <TextField
                      ...
                      onChange={(e) => updateField("no_interior", e.target.value)}
                      fullWidth
                      variant="outlined"
                      size="small"
                      sx={{
                ...
                <div className="space-y-2">
                  <Label htmlFor="id_colonia">Colonia *</Label>
                  <TextField
                    id="id_colonia"
                    select
                    value={formData.id_colonia}
                    onChange={(e) => updateField("id_colonia", e.target.value)}
                    required
                    fullWidth
                    variant="outlined"
                    size="small"
            ...
            <div className="flex justify-end gap-3 pt-4">
              <Button type="button" variant="outline" size="lg" className="min-w-[140px] bg-transparent">
                Cancelar
              </Button>
